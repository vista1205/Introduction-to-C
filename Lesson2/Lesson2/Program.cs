...
namespace Lesson2
{
    class Program
    {
        #region 6. Создать универсальную структуру расписания недели, к примеру, чтобы описать работу какого либо офиса (Enum)
        [Flags]
        public enum Day
        {
            Monday = 0b_0000001,
        ...
        static void Main(string[] args)
        {
            ...
            #region 6. Создать универсальную структуру расписания недели, к примеру, чтобы описать работу какого либо офиса
            Day Office1 = Day.Tuesday | Day.Wednesday | Day.Thursday | Day.Friday;
            Day Office2 = Day.Monday | Day.Tuesday | Day.Wednesday | Day.Thursday | Day.Friday | Day.Saturday | Day.Sunday;
            Day allDay = (Day)0b1111111;
            Day workingOffice1 = allDay & Office1;
            Day workingOffice2 = allDay & Office2;
            Console.WriteLine($"Рабочие дни первого офиса:\n{workingOffice1}\nВыходные дни первого офиса:\n{allDay ^ workingOffice1}");
            Console.WriteLine($"Рабочие дни второго офиса:\n{workingOffice2}\nВыходные дни второго офиса:\n{allDay ^ workingOffice2}");
            #endregion
        }
    }
}